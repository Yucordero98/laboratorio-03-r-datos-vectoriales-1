...
author: "Yuliany M. Cordero Artavia"
date: "2020-05-11"
output:
  html_document:
    theme: readable    
...
ggplot(centro_america, aes(x=reorder(name_long, -lifeExp), y=lifeExp)) +
  ggtitle("Esperanza de vida para los 7 países de Centroamérica") +
  xlab("Países") + 
...
```{r}
plot(centro_america["lifeExp"], main="Esperanza de vida para los 7 países de Centroamerica")
```
...
centro_america = world[(world$name_long == "Belize" |
                       ...
                       world$name_long == "Panama")
                       & world$lifeExp >= 74 , ]
plot(centro_america["lifeExp"], main="Esperanza de vida mayor o igual a 74 años para los 7 países de Centroamerica")
```